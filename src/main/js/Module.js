...
class Module extends React.Component {
	...
	handleLink(e) {
		e.preventDefault()
		this.props.lookUpLink(this.props.details)
	}
	...
	render() {
		...
		return (
			<tr>
				{ this.props.link ?
					<td key="deploymentId" className="row-title"><a href={this.props.link} target="_blank">{this.props.details['deploymentId']}</a></td>
					:
				...
				<td><button onClick={this.handleLink}>Link</button></td>
			</tr>
		)
	}
}
